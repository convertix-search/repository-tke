...
class LeadAdmin(admin.ModelAdmin):
    ...
    list_display = ('first_name', 'last_name', 'phone', 'email', 'gclid', 'transaction_id' ,'created')
...
class FormAdmin(admin.ModelAdmin):
    search_fields = ('name',)
    list_display = ('id', 'name', 'subtitle', 'subject', 'contact_form_title', 'add_gtm', 'thankyoupage_out', 'style', 'order', 'created')
    list_filter = ('created', 'add_gtm', 'style', 'thankyoupage_out')
